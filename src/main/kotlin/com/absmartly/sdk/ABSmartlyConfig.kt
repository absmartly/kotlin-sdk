...
class ABSmartlyConfig private constructor() {
    ...
    var contextDataProvider: ContextDataProvider? = null
        private set
    var contextEventHandler: ContextEventHandler? = null
        private set
    ...
    fun setContextEventHandler(handler: ContextEventHandler): ABSmartlyConfig = apply { this.contextEventHandler = handler }
